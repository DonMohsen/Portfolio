...
const Schema: z.ZodType<Prisma.ProjectsOnTechnologiesUncheckedUpdateManyWithoutProjectNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ProjectsOnTechnologiesUncheckedUpdateManyWithoutProjectNestedInputObjectSchema =
  Schema;
