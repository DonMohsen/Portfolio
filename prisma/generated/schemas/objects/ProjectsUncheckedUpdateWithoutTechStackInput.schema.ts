...
const Schema: z.ZodType<Prisma.ProjectsUncheckedUpdateWithoutTechStackInput> = z
  .object({
    id: z
      .union([
        z.number(),
...
export const ProjectsUncheckedUpdateWithoutTechStackInputObjectSchema = Schema;
