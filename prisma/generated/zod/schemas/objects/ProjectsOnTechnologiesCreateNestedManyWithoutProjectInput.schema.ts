...
const Schema: z.ZodType<Prisma.ProjectsOnTechnologiesCreateNestedManyWithoutProjectInput> =
  z
    .object({
      create: z
        .union([
...
export const ProjectsOnTechnologiesCreateNestedManyWithoutProjectInputObjectSchema =
  Schema;
