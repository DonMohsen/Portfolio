...
const Schema: z.ZodType<Prisma.ProjectsOnTechnologiesCreateNestedManyWithoutTechnologyInput> =
  z
    .object({
      create: z
        .union([
...
export const ProjectsOnTechnologiesCreateNestedManyWithoutTechnologyInputObjectSchema =
  Schema;
