...
const Schema: z.ZodType<Prisma.ProjectsOnTechnologiesUpdateManyWithoutTechnologyNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ProjectsOnTechnologiesUpdateManyWithoutTechnologyNestedInputObjectSchema =
  Schema;
