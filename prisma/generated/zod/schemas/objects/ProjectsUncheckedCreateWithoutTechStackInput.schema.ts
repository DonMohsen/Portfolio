...
const Schema: z.ZodType<Prisma.ProjectsUncheckedCreateWithoutTechStackInput> = z
  .object({
...
export const ProjectsUncheckedCreateWithoutTechStackInputObjectSchema = Schema;
