        ...
        <div className=" text-right p-7 rounded-md border border-black/[0.2] dark:border-white/[0.2] relative">
          ...
          <div className="relative mt-2">
            ...
            الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد. */}
              توسعه‌دهنده فرانت‌اند با بیش از یک سال تجربه در ساخت اپلیکیشن‌های مقیاس‌پذیر و واکنش‌گرا با استفاده از React، Next.js و TypeScript . علاقه و تجربه‌ی کار با هوش مصنوعی و پیاده سازی AI Agent های پیچیده در اپلیکیشن. آشنا به SEO و اصول رنکینگ گوگل. تسلط کامل به تولید اپلیکیشن Type Safe با وجود مدل های رابطه‌ای و پیچیده.
            </p>
          </div>
        </div>
        {/* //!تحصیلات */}
