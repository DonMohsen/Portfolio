      ...
      <div className=" text-right p-7 rounded-md border border-black/[0.2] dark:border-white/[0.2] relative">
        ...
        <div className="relative mt-2">
          ...
          <p className="pr-[50px] pl-[8px] font-IRANSansXLight">
            ...
            من محسن خجسته نژاد متولد 81 و ساکن غرب تهران هستم. ترم آخر کارشناسی
            نرم افزار کامپیوتر از دانشگاه ملی مهارت قزوین میباشم. در دوسال اخیر
            اکثر وقتم را روی یادگیری و حل چالش های مربوط به برنامه نویسی تحت وب
            کرده ام تا بعد از فارق التحصیلی، در بازار کار حرفی برای گفتن داشته
            باشم
          </p>
        </div>
      </div>
